...
class _SDTCompressor:
    ...
    _last_stored_val: Optional[int] = None
    _upper_slope: float = float("inf")
    _lower_slope: float = float("-inf")
    _pending: Optional[Tuple[float, int]] = None
    ...
    def _store(self, timestamp: float, value: int) -> None:
