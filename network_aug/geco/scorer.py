"""Scoring logic for GECO-style signal models."""
...
class GecoScoreConfig:
    """Configuration for offline GECO scoring."""
    ...
    *,
    ...
    score.alerts.append(
        GecoAlertEvent(
            ...
            register_address=score.register_address,
...
def score_geco(config: GecoScoreConfig) -> GecoScoreResult:
    """Score a signal database against a previously trained GECO model set."""
    ...
    logger.info(
        "Scored %d GECO models against %s and wrote %d alerts to %s",
